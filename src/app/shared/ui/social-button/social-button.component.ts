...
export type SocialPlatform = 'linkedin' | 'instagram' | 'vimeo' | 'flickr' | 'behance' | 'email' | 'github' | 'dribbble' | 'twitter';
...
export class SocialButtonComponent {
  ...
  get iconSvg(): string {
    const icons: Record<SocialPlatform, string> = {
      ...
      vimeo: `<path d="M13.12 10.122c.238-.223.411-.512.526-.865.114-.353.171-.735.171-1.146 0-.44-.054-.83-.162-1.17-.107-.34-.28-.622-.519-.846-.238-.224-.544-.39-.917-.497-.373-.107-.822-.161-1.347-.161H6.947v4.986h3.925c.525 0 .974-.054 1.347-.161.373-.107.679-.273.917-.497zM12.7 14.736c.336-.23.603-.537.8-.92.197-.383.295-.822.295-1.317 0-.495-.098-.934-.295-1.317-.197-.383-.464-.69-.8-.92-.336-.23-.735-.406-1.197-.527-.462-.121-.96-.182-1.495-.182H6.947v5.91h4.061c.535 0 1.033-.061 1.495-.182.462-.121.861-.297 1.197-.527zM24 7.3h-5.5v1.4H24V7.3zM18.5 0C10.492 0 4 6.492 4 14.5S10.492 29 18.5 29 33 22.508 33 14.5 26.508 0 18.5 0zm-7.553 18.7c-.736.736-1.736 1.1-3 1.1H2v-4.4h5.947c1.264 0 2.264.364 3 1.1.736.736 1.1 1.736 1.1 3s-.364 2.264-1.1 3zm12.553-3.3c0 1.5-.5 2.7-1.5 3.6s-2.4 1.35-4.2 1.35H12v-9.9h5.8c1.8 0 3.2.45 4.2 1.35s1.5 2.1 1.5 3.6z"/>`,
      
      flickr: `<path d="M6.5 12a5.5 5.5 0 1 1 11 0 5.5 5.5 0 0 1-11 0zM12 6.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11z"/>`,
      
      behance: `<path d="M6.938 4.503c.702 0 1.34.06 1.92.188.577.13 1.07.33 1.485.61.41.28.733.65.96 1.12.225.47.34 1.05.34 1.73 0 .74-.17 1.36-.507 1.86-.338.5-.837.9-1.504 1.22.906.26 1.576.72 2.022 1.37.448.66.672 1.48.672 2.49 0 .75-.13 1.39-.41 1.93-.28.55-.67 1-1.16 1.35-.48.348-1.05.6-1.67.76-.62.16-1.25.24-1.88.24H0V4.51h6.938v-.007zM3.495 8.21h2.563c.62 0 1.11-.89 1.47-.267.36-.378.54-.89.54-1.53 0-.64-.18-1.14-.54-1.52-.36-.37-.85-.56-1.47-.56H3.495v3.88zm0 7.32h2.668c.71 0 1.29-.18 1.71-.54.42-.36.63-.95.63-1.77 0-.82-.21-1.41-.63-1.77-.42-.36-1-.54-1.71-.54H3.495v4.62zm15.612-3.1c.17.73.46 1.23.87 1.49.41.26.96.39 1.64.39.48 0 .9-.08 1.27-.25.36-.17.65-.42.87-.75h2.74c-.42 1.19-1.05 2.06-1.89 2.6-.84.54-1.89.81-3.14.81-.83 0-1.59-.13-2.27-.39-.68-.26-1.27-.63-1.75-1.11-.48-.48-.85-1.06-1.11-1.73-.26-.67-.39-1.42-.39-2.24 0-.83.13-1.58.39-2.26.26-.68.63-1.26 1.1-1.73.48-.47 1.07-.84 1.75-1.1.68-.26 1.44-.39 2.27-.39.91 0 1.7.18 2.39.54.69.36 1.26.85 1.71 1.47.45.62.76 1.33.93 2.12.17.79.24 1.64.21 2.55h-8.09zm5.312-2.45c-.15-.68-.42-1.19-.81-1.53-.39-.34-.87-.51-1.46-.51-.83 0-1.41.17-1.75.51-.34.34-.58.85-.73 1.53h4.75z"/>`,
  ...
  get ariaLabel(): string {
    const labels: Record<SocialPlatform, string> = {
      ...
      vimeo: 'Visitar perfil de Vimeo',
      flickr: 'Visitar perfil de Flickr',
